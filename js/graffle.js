...
window.onload = function () {
    var dragger = function () {
        ...
        r = Raphael("holder", 720, 480),
        connections = [],
        shapes = [  r.rect(10, 200, 100, 60, 2),
                    r.rect(210, 60, 100, 60, 2),
                    r.rect(210, 200, 100, 60, 2),
                    r.rect(210, 360, 100, 60, 2),
                    r.rect(400, 60, 100, 60, 2),
                    r.rect(400, 200, 100, 60, 2),
                    r.rect(400, 360, 100, 60, 2),
                    r.rect(600, 200, 100, 60, 2),
                ];
    for (var i = 0, ii = shapes.length; i < ii; i++) {
        var color = Raphael.getColor();
        shapes[i].attr({fill: color, stroke: color, "fill-opacity": 0, "stroke-width": 3, cursor: "move"});
    ...
    connections.push(r.connection(shapes[3], shapes[6], "#000"));
    connections.push(r.connection(shapes[4], shapes[5], "#000"));
    connections.push(r.connection(shapes[5], shapes[6], "#000"));
